...
## Major New Release
  ...
  - Lots of reorganization in Form1, moving our all helper functions and extensions
...
+------------------+--------+--------+--------+
| VB.CodeConverter | 79.73% | 73.7%  | 90.13% |
+------------------+--------+--------+--------+

+---------+--------+--------+--------+
|         | Line   | Branch | Method |
+---------+--------+--------+--------+
| Total   | 79.73% | 73.7%  | 90.13% |
+---------+--------+--------+--------+
| Average | 79.73% | 73.7%  | 90.13% |
+---------+--------+--------+--------+
```