...
#Region "Default Themes"
    ...
    Public ReadOnly s_DarkThemeMappingDictionary As New Dictionary(Of String, (ForeGround As Color, Background As Color))(StringComparer.OrdinalIgnoreCase) From {
                        ...
                        {NumericLiteral, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {[Operator], (Color.FromArgb(180, 180, 180), Color.FromArgb(18, 32, 42))},
                        {OperatorOverloaded, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {ParameterName, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {PreprocessorKeyword, (Color.Gray, Color.FromArgb(18, 32, 42))},
                        {PreprocessorText, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {PropertyName, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {Punctuation, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        ...
                        {StaticSymbol, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {StringEscapeCharacter, (Color.DarkBlue, Color.FromArgb(18, 32, 42))},
                        ...
                        {Text, (Color.FromArgb(255, 255, 255), Color.FromArgb(18, 32, 42))},
                        {TypeParameterName, (Color.DarkGray, Color.FromArgb(18, 32, 42))},
                        {VerbatimStringLiteral, (Color.FromArgb(128, 0, 0), Color.FromArgb(18, 32, 42))},
                        ...
                        {"Panel", (SystemColors.ControlLight, SystemColors.ControlDark)},
                        ...
                        {"SplitContainer", (SystemColors.ControlLight, SystemColors.ControlDark)},
