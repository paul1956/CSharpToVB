...
#Region "Default Themes"
    ...
    Public ReadOnly s_DarkThemeMappingDictionary As New Dictionary(Of String, (ForeGround As Color, Background As Color))(StringComparer.OrdinalIgnoreCase) From {
                        ...
                        {"Button", (Color.White, SystemColors.ControlDark)},
                        {"CheckBox", (Color.White, SystemColors.ControlDark)},
                        {"ComboBox", (Color.White, SystemColors.ControlDark)},
                        {"ContextMenuStrip", (Color.White, SystemColors.ControlDark)},
                        {"FloatingMenu", (Color.White, SystemColors.ControlDark)},
                        {"FolderBrowserDialog", (Color.White, SystemColors.ControlDark)},
                        {"Label", (Color.White, SystemColors.ControlDark)},
                        {"LineNumbersForRichTextBox", (Color.White, SystemColors.ControlDark)},
                        {"ListBox", (Color.White, SystemColors.ControlDark)},
                        {"MenuStrip", (Color.White, Color.FromArgb(45, 45, 48))},
                        {"Panel", (Color.White, SystemColors.ControlDark)},
                        {"PanelBoarderStyle", (Color.White, SystemColors.ControlDark)},
                        {"ProgressBar", (SystemColors.Highlight, SystemColors.ControlDark)},
                        {"RichTextBox", (Color.White, Color.FromArgb(30, 30, 30))},
                        {"SplitBar", (Color.White, SystemColors.ControlDark)},
                        {"SplitContainer", (Color.White, SystemColors.ControlDark)},
                        {"StatusBar", (Color.White, Color.FromArgb(45, 45, 48))},
                        {"TextBox", (Color.White, Color.FromArgb(45, 45, 48))},
                        {"TitleBar", (Color.White, SystemColors.ControlDark)},
                        {"ToolBar", (Color.White, SystemColors.ControlDark)},
                        {"ToolStrip", (Color.White, SystemColors.ControlDark)},
                        {"ToolStripButton", (Color.White, SystemColors.MenuBar)},
                        ...
                        {"ToolStripLabel", (Color.White, SystemColors.ControlDark)},
                        {"ToolStripMenuItem", (Color.White, SystemColors.ControlDark)},
                        {"ToolStripProgressBar", (Color.White, SystemColors.ControlDark)},
                        {"ToolStripSeparator", (Color.White, SystemColors.ControlDark)},
                        {"ToolStripStatusLabel", (Color.White, SystemColors.ControlDark)},
                        {"ToolStripTextProgressBar", (Color.White, SystemColors.ControlDark)},
                        {"ToolTip", (Color.White, SystemColors.ControlDark)}
                        }
