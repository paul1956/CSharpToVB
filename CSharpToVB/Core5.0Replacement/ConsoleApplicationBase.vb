            ...
            Get
                If _commandLineArgs Is Nothing Then
                    ...
                    If EnvArgs.GetLength(0) >= 2 Then '1 element means no args, just the executing program.  >= 2 means executing program + one or more command line arguments
                        ...
                        _commandLineArgs = New System.Collections.ObjectModel.ReadOnlyCollection(Of String)(NewArgs)
                    Else
                        _commandLineArgs = New System.Collections.ObjectModel.ReadOnlyCollection(Of String)(Array.Empty(Of String))  'provide the empty set
                    End If
                End If
...
#Disable Warning CA1044 ' Properties should not be write only
        ''' <summary>
        ...
        <Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification:="<Pending>")>
        Protected WriteOnly Property InternalCommandLine() As ObjectModel.ReadOnlyCollection(Of String)
#Enable Warning CA1044 ' Properties should not be write only
            Set(ByVal value As ObjectModel.ReadOnlyCollection(Of String))
