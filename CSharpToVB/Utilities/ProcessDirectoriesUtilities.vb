        ...
        Try
            ...
            For Each SourcePathWithFileName As String In DirectoryList
                ...
                If Stats.LastFileNameWithPath.Length = 0 OrElse Stats.LastFileNameWithPath = SourcePathWithFileName Then
                    ...
                    If Not Await ProcessFileAsync(SourcePathWithFileName, TargetDirectory, SourceLanguageExtension, CSPreprocessorSymbols, VBPreprocessorSymbols, SharedReferences.CSharpReferences(Assembly.Load("System.Windows.Forms").Location, OptionalReference:=Nothing).ToArray, My.Settings.SkipAutoGenerated, CancelToken).ConfigureAwait(True) Then
