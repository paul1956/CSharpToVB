...
Partial Public Class Form1
    ...
    Private Sub mnuOptionDefaultFramework_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub mmnuOptionsFolderConversionsOptionsSkipAutoGenerated_Click(sender As Object, e As EventArgs) Handles mnuOptionsFolderConversionsOptionsSkipAutoGenerated.Click
