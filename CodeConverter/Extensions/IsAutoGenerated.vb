...
Public Module GeneratedCodeUtilities
    ...
    Private Function BeginsWithAutoGeneratedComment(
        tree As SyntaxTree, isComment As Func(Of SyntaxTrivia, Boolean), cancellationToken As CancellationToken) As Boolean
    ...
    <Extension>
    Public Function IsGeneratedCode(tree As SyntaxTree, isComment As Func(Of SyntaxTrivia, Boolean), cancellationToken As CancellationToken) As Boolean
