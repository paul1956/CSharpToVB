...
Namespace CSharpToVBCodeConverter.ToVisualBasic
    Module SyntaxKindExtensions
        ...
        <Extension>
        Friend Function ConvertOperatorKindToVBKeyword(lSyntaxKind As CS.SyntaxKind) As SyntaxToken
        ...
        <Extension>
        Public Function ConvertModifierKindToVBKeyword(t As CS.SyntaxKind, IsModule As Boolean, context As TokenContext, ByRef FoundVisibility As Boolean) As SyntaxToken
            Select Case t
