...
Public Module SyntaxNodeExtensions
    ...
    <Extension>
    Friend Function ConvertAndModifyNodeTrivia(Of T As VB.VisualBasicSyntaxNode)(Node As T, NodesOrTokens As List(Of SyntaxNodeOrToken), Index As Integer) As T
