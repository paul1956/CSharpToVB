...
Public Class ConvertRequest
    ...
    Public Sub New(mSkipAutoGenerated As Boolean, mProgressBar As TextProgressBar, mCancelToken As CancellationToken)
    ...
    Public ReadOnly Property ProgressBar As TextProgressBar
