...
Public Class ConvertRequest
    ...
    Public Sub New(mSkipAutoGenerated As Boolean, isProjectConverstion As Boolean, mProgress As IProgress(Of ProgressReport), mCancelToken As CancellationToken)
        Me.SkipAutoGenerated = mSkipAutoGenerated
        Me.IsProjectConversion = isProjectConverstion
    ...
    Public ReadOnly Property IsProjectConversion As Boolean
