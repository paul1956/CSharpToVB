...
#Region "Predefined Types"
    ...
    Public ReadOnly PredefinedTypeBoolean As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(BooleanKeyword)
    Public ReadOnly PredefinedTypeByte As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(ByteKeyword)
    Public ReadOnly PredefinedTypeChar As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(CharKeyword)
    Public ReadOnly PredefinedTypeDate As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(DateKeyword)
    Public ReadOnly PredefinedTypeDecimal As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(DecimalKeyword)
    Public ReadOnly PredefinedTypeDouble As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(DoubleKeyword)
    Public ReadOnly PredefinedTypeInteger As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(IntegerKeyword)
    Public ReadOnly PredefinedTypeLong As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(LongKeyword)
    Public ReadOnly PredefinedTypeObject As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(ObjectKeyword)
    Public ReadOnly PredefinedTypeSByte As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(SByteKeyword)
    Public ReadOnly PredefinedTypeShort As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(ShortKeyword)
    Public ReadOnly PredefinedTypeSingle As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(SingleKeyword)
    Public ReadOnly PredefinedTypeString As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(StringKeyword)
    Public ReadOnly PredefinedTypeUInteger As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(UIntegerKeyword)
    Public ReadOnly PredefinedTypeULong As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(ULongKeyword)
    Public ReadOnly PredefinedTypeUShort As Syntax.PredefinedTypeSyntax = SyntaxFactory.PredefinedType(UShortKeyword)
#End Region
