...
Public Module DoConversion
    Friend _thisLock As New Object
    ...
    Public Function ConvertInputRequest(requestToConvert As ConvertRequest, defaultVbOptions As DefaultVbOptions, csPreprocessorSymbols As List(Of String), vbPreprocessorSymbols As List(Of KeyValuePair(Of String, Object)), optionalReferences() As MetadataReference, reportException As Action(Of Exception), mProgress As IProgress(Of ProgressReport)) As ConversionResult
        ...
        Try
            Dim sourceTree As CS.CSharpSyntaxNode = DirectCast(tree.GetRoot(requestToConvert.CancelToken), CS.CSharpSyntaxNode)
            ...
            Else
                ...
                Dim pSemanticModel As SemanticModel = compilation.GetSemanticModel(tree, ignoreAccessibility:=True)

                Dim convertedNode As VB.VisualBasicSyntaxNode =
                        sourceTree.DoConversion(pSemanticModel,
                                                defaultVbOptions,
                                                codeWithOptions.Request.SkipAutoGenerated,
                                                requestToConvert.IsProjectConversion,
                                                reportException,
                                                mProgress,
                                                If(requestToConvert.IsProjectConversion, GetGlobalSymbols(compilation), New List(Of String)),
