...
#Enable Warning CA1826 ' Do not use Enumerable methods on indexable collections
            ...
            Public Overrides Function VisitLocalFunctionStatement(node As CSS.LocalFunctionStatementSyntax) As SyntaxList(Of StatementSyntax)
                ...
                ElseIf node.AttributeLists.Count > 0 Then
                    Dim attributes As New List(Of AttributeListSyntax)
                    ...
                    _nodesVisitor.ConvertAndSplitAttributes(node.AttributeLists, attributes, returnAttributes, functionStmtTrailingTrivia)
