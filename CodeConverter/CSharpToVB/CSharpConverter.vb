...
Namespace CSharpToVBCodeConverter.Visual_Basic
    ...
    Partial Public Class CSharpConverter
        ...
        ''' <returns></returns>
        Public Shared Function Convert(SourceTree As CS.CSharpSyntaxNode, _SkipAutoGenerated As Boolean, _SemanticModel As SemanticModel, CancelToken As CancellationToken) As VB.VisualBasicSyntaxNode
            Dim visualBasicSyntaxNode1 As VB.VisualBasicSyntaxNode
            If OriginalRequest Is Nothing Then
                OriginalRequest = New ConvertRequest(_SkipAutoGenerated, Sub() Return, mProgressBar:=Nothing, CancelToken)
            End If
            SyncLock ThisLock
                ClearMarker()
