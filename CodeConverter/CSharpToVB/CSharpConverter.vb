...
Namespace CSharpToVBCodeConverter.DestVisualBasic
    ...
    Partial Public Class CSharpConverter
        ...
        ''' <returns></returns>
        Public Shared Function Convert(SourceTree As CS.CSharpSyntaxNode, SkipAutoGenerated As Boolean, pSemanticModel As SemanticModel, ReportException As Action(Of Exception), ProgressReport As ITextProgressBar, CancelToken As CancellationToken) As VB.VisualBasicSyntaxNode
