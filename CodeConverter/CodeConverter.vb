...
Namespace CSharpToVBCodeConverter
    Public Module CodeConverter
        ...
        Public Function ConvertInputRequest(RequestToConvert As ConvertRequest, OptionalReferences() As MetadataReference, CancelToken As CancellationToken) As ConversionResult
